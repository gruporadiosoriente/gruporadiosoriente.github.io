...
const canciones = [
  "ALBERTO CASTILLO - LO QUE YO SIENTO POR TI.mp3",
  "CRISTOBAL JIMENEZ - ALCARAVAN COMPANERO.mp3",
  "ALEJANDRO RONDON - IRONIA.mp3",
  "LILIBETH FIGUERA - LA LLANURA Y SUS ENCANTOS.mp3",
  "LUIS SILVA - A QUIEN NO LE VA A GUSTAR.mp3",
  "RAFAEL VOLCAN - EL HOMBRE DEL TRIPLE.mp3",
  "YENIFER MORA - CAMPESINA HASTA LA CACHA.mp3",
  "VITICO CASTILLO - CORAZON DE CONCRETO.mp3",
  "REYNALDO ARMAS - EL ZAMURO Y EL AVION.mp3",
  "ALI CABELLO - ME ENAMORE.mp3",
  "JORGE GUERRERO - TARDES GRISES DE JUNIO.mp3",
